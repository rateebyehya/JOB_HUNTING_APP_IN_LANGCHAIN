...
#
st.title('🤖 AI WEBSITE ASSISTANCE') 
...
prompt = st.text_input('How can I help you today?',key="prompt")  # The box for the text prompt
document_count = st.slider('No.Of links to return 🔗 - (1 LOW || 5 HIGH)', 1, 5, 2,step=1)
